...
int FaceAligner::Impl::align_face(const cv::Mat &img_src, const std::vector<cv::Point2f> &landmark, cv::Mat &face_aligned)
{
...
{
	return impl->align_face(img_src, landmark, face_aligned);
}